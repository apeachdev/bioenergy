	...
	*/
	public function register () {
		...
		$this->wp_customize->add_setting( new ProteusThemes_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'header_bg', array(
			...
			'css_map' => array(
				'background-color' => array(
					...
					'.header__logo::after',
					'.header__container|@media (max-width: 992px)',
		...
		$this->wp_customize->add_setting( new ProteusThemes_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'main_navigation_link_mobile_color', array(
			...
			'css_map' => array(
				'color' => array(
					'.main-navigation > li > a|@media (max-width: 992px)',
				),
			)
		) ) );
		$this->wp_customize->add_setting( new ProteusThemes_Customize_Setting_Dynamic_CSS( $this->wp_customize, 'main_navigation_link_mobile_color_hover', array(
			...
			'css_map' => array(
				'color' => array(
					'.main-navigation > li:hover > a|@media (max-width: 992px)',
					'.main-navigation > li:focus > a|@media (max-width: 992px)',
				),
			)
		) ) );
		...
		// individual sections
		$this->wp_customize->add_section( 'cargopress_section_logos', array(
			'title'       => _x( 'Logo &amp; Favicon', 'backend', 'cargopress-pt' ),
			'description' => _x( 'Logo &amp; Favicon for the CargoPress theme.', 'backend', 'cargopress-pt' ),
			'priority'    => 10,
		...
		$this->wp_customize->add_control( 'tf_username', array(
			'label'       => _x( 'Your ThemeForest username', 'backend', 'cargopress-pt' ),
			'description' => _x( 'Your Envato marketplace (ThemeForest) username.', 'backend', 'cargopress-pt' ),
			'section'     => 'section_updates',
		) );

		$this->wp_customize->add_control( 'tf_api_key', array(
			'label'       => _x( 'Your ThemeForest API key', 'backend', 'cargopress-pt' ),
			'description' => _x( 'Your API key (<strong>not</strong> password). See <a href="https://www.diigo.com/item/p/pdbsqoszbspabboqezbcoserod" target="_blank">here</a> where you can generate your new API key on ThemeForest site.', 'backend', 'cargopress-pt' ),
			'section'     => 'section_updates',
		) );
